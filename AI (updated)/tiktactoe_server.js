...
app.post('/post', (req, res) => {
    ...
    if (z['action']=='generateCode') {
        ...
        var jsontext = JSON.stringify({
            /*TODO 3 ... type of action */ 'action': 'generateCode',
            /*TODO 4 ... won or not */'won': win,
            /*TODO 5 ... number of match*/'num_match': num_match,
            /*TODO 6 ... number of correct colors*/'num_correct_colors' : num_containing,
            /*TODO 7 ... number of wrong colors*/'num_wrong_colors' : num_not_in,
            /*TODO 8 ... the answer code when the game ends*/'answer' : answer
        });
        console.log(jsontext);
        res.send(jsontext);
    } else {
